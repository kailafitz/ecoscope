  ...
  return (
    <section className="mb-16 lg:mb-12">
      ...
      <p className="w-full lg:w-2/3">
        ...
        behind-the-scenes highlights, we&39;re here to keep you in the know. Our
        commitment to sharing timely and accurate information ensures you&39;re
        always up-to-date. Dive in and discover what&39;s new and noteworthy
        today!
      </p>
    </section>
  );
